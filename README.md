# LINE Wrapper
This is a basic Electron wrapper for the LINE web app. This is NOT an official LY Corporation product, it simply uses Electron to present the LINE web application as if it were its own dedicated application (like [LINE Desktop](https://apps.microsoft.com/detail/xpfcc4cd725961?hl=en-US&gl=US), but for Linux or situations where the official app doesn't work on Windows). Use at your own risk.
